...
class Grasp(Action):
    def __init__(self):
        ...
        self.pre = [\
            ...
            ('(EEReachable ?robot ?sp ?ee)', '20:20'),
            ('(EEReachableRot ?robot ?sp ?ee)', '20:20'),
            ('(InContact ?robot ?ee ?target)', '20:39'),
            ('(GraspValid ?ee ?target)', '20:20'),
            ('(GraspValidRot ?ee ?target)', '20:20'),
            ('(forall (?obj - Can)\
            ...
            # ('(forall (?obj - Can) (StationaryNEq ?obj ?can))', '20:38'),
            ('(forall (?w - Obstacle)\
                (StationaryW ?w)\
            )', '0:38'),
        ...
        self.eff = [\
            ...
            ('(InGripper ?robot ?can)', '21:39'),
            ('(InGripperRot ?robot ?can)', '21:39'),

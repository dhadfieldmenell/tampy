...
class MoveTo(Action):
    def __init__(self):
        ...
        self.pre = [\
                ...
                ('(not (GripperClosed ?robot))', '1:{0}'.format(et-2)),
                ('(GripperClosed ?robot)', '{0}:{0}'.format(et-1)),

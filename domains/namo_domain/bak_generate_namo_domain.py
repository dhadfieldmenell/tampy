...
class Transfer(Action):
    def __init__(self):
        ...
        self.eff = [\
                ...
                #('(forall (?targ - Target) (forall (?gr - Grasp) (not (HLTransferFailed ?targ ?gr))))', '{0}:{0}'.format(et,et-1)),

...
class Transfer(Action):
    def __init__(self):
        ...
        self.pre = [\
                ...
                ('(forall (?obj - Can) (not (WideObstructsHolding ?robot ?t ?t ?obj ?c)))', '0:{0}'.format(-1)),
                ('(forall (?obj - Can) (not (WideObstructsHolding ?robot ?t ?t ?obj ?c)))', '1:{0}'.format(et-1)),
        ...
        self.eff = [\
                ...
                ('(forall (?obj - Can) (forall (?gr - Grasp) (not (HLGraspFailed ?obj ?gr))))', '{0}:{0}'.format(et,et-1)),
                ('(forall (?obj - Can) (forall (?targ - Target) (forall (?gr - Grasp) (not (HLTransferFailed ?obj ?targ ?gr)))))', '{0}:{0}'.format(et,et-1)),

...
class MoveTo(Action):
    def __init__(self):
        ...
        self.pre = [\
                ('(At ?can ?target)', '0:0'),
                ('(forall (?gr - Grasp) (forall (?obj - Can) (not (RobotAtGrasp ?robot ?obj ?gr))))', '0:0'),
                ...
                ('(forall (?obj - Can) (not (WideObstructs ?robot ?target ?target ?obj)))', '1:{0}'.format(et-2)),
                ('(forall (?obj - Can) (not (Obstructs ?robot ?target ?target ?obj)))', '{0}:{1}'.format(et-1, et-1)),
...
class Transfer(Action):
    def __init__(self):
        ...
        self.pre = [\
                ...
                ('(RobotAtGrasp ?robot ?c ?g)', '{0}:{0}'.format(et)),

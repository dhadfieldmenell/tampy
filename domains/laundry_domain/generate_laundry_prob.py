...
GOAL = "(BaxterAt basket end_target), (BaxterRobotAt baxter robot_end_pose)"
...
def main():
    for iteration in range(NUM_PROBS):
        ...
        s += "(geom washer), "
        s += "(pose washer {}), ".format(0,0,0)
        s += "(rotation washer {}), ".format([0,0,0])
        ...
        s += "(BaxterEEReachableVerLeftPos baxter robot_grasp_begin grasp_ee_left), "
        s += "(BaxterEEReachableVerLeftPos baxter robot_grasp_begin grasp_ee_left), "
        s += "(BaxterEEReachableVerLeftPos baxter robot_grasp_begin grasp_ee_right), "
        s += "(BaxterEEReachableVerLeftPos baxter robot_grasp_begin grasp_ee_right) ,"
        s += "(BaxterBasketInContact baxter grasp_ee_left grasp_ee_right init_target), "
        s += "(BaxterBasketInContact baxter putdown_ee_left putdown_ee_right end_target), "
        ...
        s += "(BaxterBasketInGripperPos baxter basket), "
        s += "(BaxterBasketInGripperRot baxter basket), "

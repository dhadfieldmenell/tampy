...
pp.add('Robot', [('geom', 'Baxter'),
                ...
                ('rArmPose', 'ArmPose7d'),
                ('rGripper', 'Vector1d'),
                ('ee_left_pos', 'Vector3d'),
                ('ee_left_rot', 'Vector3d'),
                ('ee_right_pos', 'Vector3d'),
                ('ee_right_rot', 'Vector3d')])
...
dp.add('BaxterEELeftValid', ['Robot'])
dp.add('BaxterEERightValid', ['Robot'])
...
dp.add('BaxterGrippersDownRot', ['Robot'])
dp.add('BaxterGrippersWithinDistance', ['Robot', 'Can'])
dp.add('BaxterGrippersAtDistance', ['Robot', 'Can'])
dp.add('BaxterTargetWithinReachLeft', ['ClothTarget'])
dp.add('BaxterTargetWithinReachRight', ['ClothTarget'])
dp.add('BaxterClothAlmostInGripperLeft', ['Robot', 'Cloth'])
dp.add('BaxterClothAlmostInGripperRight', ['Robot', 'Cloth'])
...
class Move(Action):
    def __init__(self):
        ...
        self.pre = [\
            ...
            ('(BaxterEELeftValid ?robot)', '0:{}'.format(end)),
            ('(BaxterEERightValid ?robot)', '0:{}'.format(end)),
            ...
            ('(forall (?obj - Cloth) (not (BaxterClothAlmostInGripperLeft ?robot ?obj)))', '{}:{}'.format(0, 0)),
            ('(forall (?obj - Cloth) (not (BaxterClothAlmostInGripperRight ?robot ?obj)))', '{}:{}'.format(0, 0)),
            ('(forall (?obj - Basket)\
...
class MoveHoldingDeformableCloth(Action):
    def __init__(self):
        self.name = 'move_holding_deformable_cloth'
        self.timesteps = 20
        end = self.timesteps - 1
        self.args = '(?robot - Robot ?start - RobotPose ?end - RobotPose ?edge - Can)'
        self.pre = [\
            ('(BaxterRobotAt ?robot ?start)', '0:0'),
            ('(BaxterGrippersWithinDistance ?robot ?edge)', '0:{}'.format(end)),
            ('(BaxterGrippersDownRot ?robot)', '0:{}'.format(end)),
        ...
        self.eff = [\
            ('(not (BaxterRobotAt ?robot ?start))', '{}:{}'.format(end, end-1)),
            ('(BaxterRobotAt ?robot ?end)', '{}:{}'.format(end, end)),
            ('(BaxterBothEndsInGripper ?robot ?edge)', '{}:{}'.format(end, end)),
        ]

class MoveHoldingDeformableClothToEE(Action):
    def __init__(self):
        self.name = 'move_holding_deformable_cloth_to_ee'
        self.timesteps = 20
        end = self.timesteps - 1
        self.args = '(?robot - Robot ?start - RobotPose ?end - RobotPose ?edge - Can ?ee_left - EEPose ?ee_right - EEPose ?lcloth - Cloth ?rcloth - Cloth)'
        self.pre = [\
            ('(BaxterRobotAt ?robot ?start)', '0:0'),
            ('(BaxterClothAlmostInGripperLeft ?robot ?lcloth)', '0:0'),
            ('(BaxterClothAlmostInGripperRight ?robot ?rcloth)', '0:0'),
            ('(BaxterEELeftValid ?robot)', '0:{}'.format(end)),
            ('(BaxterEERightValid ?robot)', '0:{}'.format(end)),
            ('(BaxterGrippersWithinDistance ?robot ?edge)', '0:{}'.format(end)),
            ('(BaxterGrippersDownRot ?robot)', '0:{}'.format(end)),
        ...
        self.eff = [\
            ...
            ('(BaxterRobotAt ?robot ?end)', '{}:{}'.format(end, end)),
            ('(BaxterBothEndsInGripper ?robot ?edge)', '{}:{}'.format(end, end)),
            ('(BaxterClothInGripperLeft ?robot ?lcloth)', '{}:{}'.format(1, end)),
            ('(BaxterClothInGripperRight ?robot ?rcloth)', '{}:{}'.format(1, end)),
        ]
...
class MoveHoldingCloth(Action):
    def __init__(self):
        ...
        self.pre = [\
            ...
            ('(BaxterEELeftValid ?robot)', '0:{}'.format(end)),
            ('(BaxterEERightValid ?robot)', '0:{}'.format(end)),
            ('(BaxterClothAlmostInGripperLeft ?robot ?cloth)', '0:0'),
...
class MoveHoldingClothToEELeft(Action):
    def __init__(self):
        self.name = 'moveholding_cloth_to_ee_left'
        self.timesteps = 20
        end = self.timesteps - 1
        self.args = '(?robot - Robot ?start - RobotPose ?end - RobotPose ?end_left - EEPose ?end_right - EEPose ?cloth - Cloth)'
        self.pre = [\
            ('(BaxterRobotAt ?robot ?start)', '0:0'),
            ('(BaxterEELeftValid ?robot)', '0:{}'.format(end)),
            ('(BaxterEERightValid ?robot)', '0:{}'.format(end)),
...
class BothMoveCloths(Action):
    def __init__(self):
        self.name = 'both_move_cloths'
        self.timesteps = 20
        end = self.timesteps - 1
        self.args = '(?robot - Robot  ?cloth - Can ?target - ClothTarget ?lcloth - Cloth ?rcloth - Cloth ?ee_left - EEPose ?ee_right - EEPose ?start - RobotPose ?end - RobotPose)'
        self.pre = [\
            ('(BaxterRobotAt ?robot ?start)', '0:0'),
            ('(BaxterEELeftValid ?robot)', '0:{}'.format(end)),
            ('(BaxterEERightValid ?robot)', '0:{}'.format(end)),
        ...
        self.eff = [\
            ...
            ('(not (BaxterRobotAt ?robot ?start))', '{}:{}'.format(end, end-1)),
            ('(BaxterRobotAt ?robot ?end)', '{}:{}'.format(end, end)),
            ('(BaxterGrippersAtDistance ?robot ?cloth)', '0:{}'.format(end)),
            ('(BaxterEdgeAt ?cloth ?target)', '{}:{}'.format(end, end))
        ]
...
class MoveHoldingClothRight(Action):
    def __init__(self):
        ...
        self.pre = [\
            ...
            ('(BaxterEELeftValid ?robot)', '0:{}'.format(end)),
            ('(BaxterEERightValid ?robot)', '0:{}'.format(end)),
            ('(BaxterClothAlmostInGripperRight ?robot ?cloth)', '0:0'),
            # ('(BaxterClothInGripperLeft ?robot ?cloth)', '0:{}'.format(end)),
            ('(BaxterCloseGrippers ?robot)', '1:{}'.format(end)),
            ('(BaxterGrippersDownRot ?robot)', '0:{}'.format(end)),
            ('(forall (?obj - Basket)\
...
class MoveHoldingClothToEERight(Action):
    def __init__(self):
        self.name = 'moveholding_cloth_to_ee_right'
        self.timesteps = 20
        end = self.timesteps - 1
        self.args = '(?robot - Robot ?start - RobotPose ?end - RobotPose ?end_left - EEPose ?end_right - EEPose ?cloth - Cloth)'
        self.pre = [\
...
class BothEndClothGrasp(Action):
    def __init__(self):
        ...
        self.args = '(?robot - Robot ?left_corner - Cloth ?right_corner - Cloth ?cloth - Can ?target - ClothTarget ?sp - RobotPose ?ee_left - EEPose ?ee_right - EEPose ?ep - RobotPose)'
        grasp_time = const.EEREACHABLE_STEPS+5
        approach_time = 5
        retreat_time = end-5
        self.pre = [\
            ...
            ('(BaxterEELeftValid ?robot)', '0:{}'.format(end)),
            ('(BaxterEERightValid ?robot)', '0:{}'.format(end)),
            ('(BaxterEdgeBetween ?cloth ?left_corner ?right_corner)', '0:0'),
            ('(BaxterRobotAt ?robot ?sp)', '0:0'),
            ('(BaxterGrippersDownRot ?robot)', '0:{}'.format(end)),
            ('(BaxterEEReachableLeftVer ?robot ?sp ?ee_left)', '{}:{}'.format(grasp_time, grasp_time)),
            ('(BaxterEEReachableRightVer ?robot ?sp ?ee_right)', '{}:{}'.format(grasp_time, grasp_time)),
...
class ClothGraspBoth(Action):
    def __init__(self):
        self.name = 'cloth_grasp_both'
        self.timesteps = 2 * const.EEREACHABLE_STEPS + 11
        end = self.timesteps - 1
        self.args = '(?robot - Robot ?lcloth - Cloth ?rcloth - Cloth ?ltarget - ClothTarget ?rtarget - ClothTarget ?sp - RobotPose ?ee_left - EEPose ?ee_right - EEPose ?ep - RobotPose)'
        grasp_time = const.EEREACHABLE_STEPS+5
        approach_time = 5
        retreat_time = end-5
        self.pre = [\
            ('(BaxterClothAt ?lcloth ?ltarget)', '1:1'),
            ('(BaxterClothAt ?rcloth ?rtarget)', '1:1'),
            ('(BaxterRobotAt ?robot ?sp)', '0:0'),
            ('(BaxterEELeftValid ?robot)', '0:{}'.format(end)),
            ('(BaxterEERightValid ?robot)', '0:{}'.format(end)),
            ('(BaxterGrippersDownRot ?robot)', '0:{}'.format(end)),
            ('(BaxterEEReachableLeftVer ?robot ?sp ?ee_left)', '{}:{}'.format(grasp_time, grasp_time)),
            ('(BaxterEEReachableRightVer ?robot ?sp ?ee_right)', '{}:{}'.format(grasp_time, grasp_time)),
            ('(BaxterClothInGripperLeft ?robot ?lcloth)', '{}:{}'.format(grasp_time, end)),
            ('(BaxterClothGraspValid ?ee_left ?ltarget)', '{}:{}'.format(grasp_time, grasp_time)),
            ('(BaxterClothInGripperRight ?robot ?rcloth)', '{}:{}'.format(grasp_time, end)),
            ('(BaxterClothGraspValid ?ee_right ?rtarget)', '{}:{}'.format(grasp_time, grasp_time)),
            ('(BaxterOpenGripperLeft ?robot)', '{}:{}'.format(0,  grasp_time-1)),
            ('(BaxterCloseGripperLeft ?robot)', '{}:{}'.format(grasp_time,  end)),
            ('(BaxterOpenGripperRight ?robot)', '{}:{}'.format(0,  grasp_time-1)),
            ('(BaxterCloseGripperRight ?robot)', '{}:{}'.format(grasp_time,  end)),
            ('(BaxterStationaryCloth ?lcloth)', '{}:{}'.format(1, grasp_time-1)),
            ('(BaxterStationaryCloth ?rcloth)', '{}:{}'.format(1, grasp_time-1)),
            ('(forall (?obj - Basket) \
                (BaxterStationary ?obj)\
            )', '0:{}'.format(end-1)),
            ('(forall (?obs - Washer)\
        ...
        self.eff = [\
            ('(not (BaxterClothAt ?lcloth ?ltarget))', '{}:{}'.format(end, end-1)),
            ('(not (BaxterClothAt ?rcloth ?rtarget))', '{}:{}'.format(end, end-1)),
            ('(not (BaxterRobotAt ?robot ?sp))', '{}:{}'.format(end, end-1)),
            ('(BaxterRobotAt ?robot ?ep)', '{}:{}'.format(end, end)),
            ('(BaxterClothInGripperLeft ?robot ?lcloth)', '{}:{}'.format(end, end)),
            ('(BaxterClothInGripperRight ?robot ?rcloth)', '{}:{}'.format(end, end)),
            ('(forall (?sym1 - Robotpose)\
                (forall (?sym2 - RobotPose)\
                    (forall (?obj - Basket) (not (BaxterObstructsHoldingCloth ?robot ?sym1 ?sym2 ?obj ?lcloth)))\
                )\
            )', '{}:{}'.format(end, end-1)),
            ('(forall (?sym1 - Robotpose)\
                (forall (?sym2 - RobotPose)\
                    (forall (?obj - Basket) (not (BaxterObstructsHoldingCloth ?robot ?sym1 ?sym2 ?obj ?rcloth)))\
                )\
            )', '{}:{}'.format(end, end-1))
        ]
...
class ClothPutdownNear(Action):
    def __init__(self):
        self.name = 'cloth_putdown_near'
        self.timesteps = 2 * const.EEREACHABLE_STEPS + 11
        end = self.timesteps - 1
        self.args = '(?robot - Robot ?cloth - Cloth ?target - ClothTarget ?ref - ClothTarget ?sp - RobotPose ?ee_left - EEPose ?ep - RobotPose)'
        putdown_time = const.EEREACHABLE_STEPS+5
        approach_time = 5
        retreat_time = end-5
        self.pre = [\
...
class ClothPutdownNearRight(Action):
    def __init__(self):
        self.name = 'cloth_putdown_near_right'
        self.timesteps = 2 * const.EEREACHABLE_STEPS + 11
        end = self.timesteps - 1
        self.args = '(?robot - Robot ?cloth - Cloth ?target - ClothTarget ?ref - ClothTarget ?sp - RobotPose ?ee_right - EEPose ?ep - RobotPose)'
        putdown_time = const.EEREACHABLE_STEPS+5
        approach_time = 5
        retreat_time = end-5
        self.pre = [\
...
class BothEndClothPutdown(Action):
    def __init__(self):
        self.name = 'both_end_cloth_putdown'
        self.timesteps = 2 * const.EEREACHABLE_STEPS + 11
        end = self.timesteps - 1
        self.args = '(?robot - Robot ?left_corner - Cloth ?right_corner - Cloth ?cloth - Can ?target - ClothTarget ?sp - RobotPose ?ee_left - EEPose ?ee_right - EEPose ?ep - RobotPose)'
        putdown_time = const.EEREACHABLE_STEPS+5
        ...
        self.pre = [\
            ...
            ('(BaxterEEReachableLeftVer ?robot ?sp ?ee_left)', '{}:{}'.format(putdown_time, putdown_time)),
            ('(BaxterEEReachableRightVer ?robot ?sp ?ee_right)', '{}:{}'.format(putdown_time, putdown_time)),
            ('(BaxterBothEndsInGripper ?robot ?cloth)', '{}:{}'.format(0, putdown_time)),
            ('(BaxterClothBothGraspValidLeft ?ee_left ?target ?cloth)', '{}:{}'.format(putdown_time, putdown_time)),
            ('(BaxterClothBothGraspValidRight ?ee_right ?target ?cloth)', '{}:{}'.format(putdown_time, putdown_time)),
            ('(BaxterOpenGripperLeft ?robot)', '{}:{}'.format(putdown_time, end)),
            ('(BaxterCloseGripperLeft ?robot)', '{}:{}'.format(1, putdown_time-1)),
            ('(BaxterOpenGripperRight ?robot)', '{}:{}'.format(putdown_time, end)),
            ('(BaxterCloseGripperRight ?robot)', '{}:{}'.format(1, putdown_time-1)),
            ('(BaxterStationaryEdge ?cloth)', '{}:{}'.format(putdown_time, end)),
            ('(forall (?obj - Basket) \
                (BaxterStationary ?obj)\
            )', '0:{}'.format(end-1)),
            ('(forall (?obs - Washer)\
        ...
        self.eff = [\
            ('(BaxterEdgeAt ?cloth ?target)', '{}:{}'.format(end, end)),
            ('(BaxterEdgeBetween ?cloth ?left_corner ?right_corner)', '{}:{}'.format(end, end)),
            ('(not (BaxterRobotAt ?robot ?sp))', '{}:{}'.format(end, end-1)),
            ('(BaxterRobotAt ?robot ?ep)', '{}:{}'.format(end, end)),
        ]
...
class MoveToEEPosRight(Action):
    def __init__(self):
        self.name = 'moveto_ee_pos_right'
        self.timesteps = 30
        end = self.timesteps - 1
        self.args = '(?robot - Robot ?ee_right - EEPose ?start - RobotPose ?end - RobotPose)'
        self.pre = [\
            ('(forall (?obj - Basket)\
                (not (BaxterBasketInGripper ?robot ?obj))\
            )', '{}:{}'.format(0, 0)),
...
actions = [Move(), MoveHoldingBasket(), MoveHoldingCloth(), Grasp(), Putdown(), 
           ...
           MoveHoldingClothToEELeft(), MoveHoldingClothToEERight(),
           ClothGraspBoth(), BothEndClothPutdown(), MoveHoldingDeformableClothToEE(),
           BothMoveCloths(), ClothPutdownNear(), ClothPutdownNearRight(), MoveToEEPosRight()]

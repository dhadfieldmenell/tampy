...
# SEED = 1234
NUM_PROBS = 1
filename = "laundry_probs/move_into_washer_isolation.prob"
...
BAXTER_INIT_L_ARM = [1.5, -0.95913869, -0.5763008,  2.39597348, 1.04915689, -1.18977562, -0.01895105]
BAXTER_OPEN_GRIPPER = [0.02]
# robot_end_pose
BAXTER_END_POSE = [0]
BAXTER_END_R_ARM = [0, -0.785, 0, 0, 0, 0, 0]
BAXTER_END_L_ARM = [0.6, -0.2592598, -0.54116997, 1.22969066, -1.55244325, 0.95829453,  2.58559596]
BAXTER_CLOSE_GRIPPER = [0.015]


MONITOR_L_ARM = [0.6, -0.25925975, -0.54116997,  1.22969061, -1.55244322, 0.95829454,  2.58559595]
...
WASHER_INIT_POS = [1.0, 0.84, 0.867]
WASHER_INIT_ROT = [np.pi/2,0,0]
WASHER_OPEN_DOOR = [-np.pi/2]
WASHER_CLOSE_DOOR = [-np.pi/2]
...
def main():
    for iteration in range(NUM_PROBS):
        ...
        s += get_robot_pose_str('robot_end_pose', BAXTER_END_L_ARM, BAXTER_INIT_R_ARM, BAXTER_OPEN_GRIPPER, BAXTER_END_POSE)

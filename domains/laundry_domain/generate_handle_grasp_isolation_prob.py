...
# init Baxter pose
BAXTER_INIT_POSE = [0]
R_ARM_INIT = [0, -np.pi/2, 0, 0, 0, 0, 0]
L_ARM_INIT = [ 0.   ,  0.291, -0.701,  1.136,  2.703, -1.298, -2.189]
INT_GRIPPER = [0.02]

BAXTER_END_POSE = [0]
R_ARM_END = [0, -np.pi/2, 0, 0, 0, 0, 0]
L_ARM_END = [-0.2  ,  0.478, -0.812,  1.093,  2.686, -1.085, -2.12 ]

END_GRIPPER = [0.015]
# init basket pose
BASKET_INIT_POS = [1 , 1,  1]

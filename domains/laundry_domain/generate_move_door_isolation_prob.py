...
# SEED = 1234
NUM_PROBS = 1
filename = "laundry_probs/move_door_isolation.prob"
GOAL = "(BaxterRobotAt baxter robot_end_pose), (BaxterWasherAt washer washer_end_pose)"


# init Baxter pose
BAXTER_INIT_POSE = [np.pi/2]
R_ARM_INIT = [ 0.9 , -0.25826126,  0.55732164,  1.84194696, -2.90683592, 1.67907567,  1.04319258]
L_ARM_INIT = [ 0.3, -0.54512685, -1.21983209,  1.84432598,  1.08901496, 1.13391635, -0.55092932]
INT_GRIPPER = [0.015]

BAXTER_END_POSE = [np.pi/2]
R_ARM_END = [-0.6 , -0.75258525,  1.12103789,  2.09743261, -0.4897393 , -0.73038969, -0.38670057]

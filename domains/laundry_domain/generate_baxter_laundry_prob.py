...
LEFT_CLOTH_TARGET_0_POSE = [0.5, 0.2, 0.655]
...
RIGHT_CLOTH_TARGET_0_POSE = [0.5, -0.2, 0.655]
...
LEFT_CLOTH_TARGET_OFF_0_POSE = [0.5, -0.2, 0.655]
...
RIGHT_CLOTH_TARGET_OFF_0_POSE = [0.5, 0.2, 0.655]
...
def main():
    for iteration in range(NUM_PROBS):
        for NUM_CLOTH in range(NUM_CLOTHS):
            NUM_SYMBOLS = NUM_CLOTH * 2

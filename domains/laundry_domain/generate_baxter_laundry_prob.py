...
# SEED = 1234
NUM_PROBS = 1
filename = "laundry_probs/baxter_laundry.prob"
...
WASHER_INIT_POS = [0.97, 1.10, 0.97-0.375+0.65/2]
...
def main():
    for iteration in range(NUM_PROBS):
        ...
        for i in range(NUM_SYMBOLS):
            ...
            s += "RobotPose (name {}); ".format("open_door_ee_approach_{0}".format(i))
            s += "RobotPose (name {}); ".format("open_door_ee_retreat_{0}".format(i))
            s += "RobotPose (name {}); ".format("close_door_ee_approach_{0}".format(i))
            s += "RobotPose (name {}); ".format("close_door_ee_retreat_{0}".format(i))
        ...
        for i in range(NUM_SYMBOLS):
            ...
            s += get_undefined_robot_pose_str("open_door_ee_approach_{0}".format(i))
            s += get_undefined_robot_pose_str("open_door_ee_retreat_{0}".format(i))
            s += get_undefined_robot_pose_str("close_door_ee_approach_{0}".format(i))
            s += get_undefined_robot_pose_str("close_door_ee_retreat_{0}".format(i))
            ...
            s += "(door washer_open_pose_{0} undefined), ".format(i)

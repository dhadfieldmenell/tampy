...
# SEED = 1234
NUM_PROBS = 1
filename = "laundry_probs/push_door_isolation.prob"
...
L_ARM_INIT = [0.00000000e+00,  -1.51329561e+00,  -8.15587931e-03,  1.32186633e+00,  4.77430770e-04,  1.76222750e+00,  7.77348435e-01]
INT_GRIPPER = [0.02]

BAXTER_END_POSE = [0]
R_ARM_END = [0, -0.785, 0, 0, 0, 0, 0]
L_ARM_END = [0.5,  -1.27893204,  -0.05672483,  1.32735454,  0.01633266,  1.52282351,  1.230286  ]

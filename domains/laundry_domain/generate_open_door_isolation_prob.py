...
L_ARM_INIT = [ 1.3, -0.43792909, -0.49808747,  2.25610238,  1.79590401, -1.0903989 ,  0.07429107]
INT_GRIPPER = [0.02]

BAXTER_END_POSE = [0]
R_ARM_END = [0, -0.785, 0, 0, 0, 0, 0]
L_ARM_END = [ 1.4, -0.50138441, -0.1515132 ,  1.7451289 , -1.01796693, 1.63150759,  2.79001151]

...
# SEED = 1234
NUM_PROBS = 1
filename = "laundry_probs/move_around_washer.prob"
...
R_ARM_END = [-np.pi/4, -np.pi/4, 0, 0, 0, 0, 0]
L_ARM_END= [1.43965299, -0.18943469, -0.82355305, 1.49084849, -0.81535983, 1.10335637, 2.40226609]
...
WASHER_GEOM = [.325, .325, .325]


CLOTH_INIT_POS_1 = [0.65 , 0,  0.601]
CLOTH_INIT_ROT_1 = [0,0,0]

CLOTH_END_POS_1 = [0.65, 0,  0.601]
CLOTH_END_ROT_1 = [0,0,0]


CLOTH_END_POS_2 = [0.95,  0.84, 0.70]
...
def main():
    for iteration in range(NUM_PROBS):
        ...
        s += get_robot_pose_str('robot_end_pose', L_ARM_END, R_ARM_END, CLOSE_GRIPPER, BAXTER_INIT_POSE)
        # s += get_robot_pose_str('monitor_pose', MONITOR_LEFT, MONITOR_RIGHT, INT_GRIPPER, BAXTER_INIT_POSE)

        s += "(geom washer {}), ".format(WASHER_GEOM)
        ...
        # s += "(door washer_init_pose {}), ".format(WASHER_OPEN_DOOR)

...
L_ARM_INIT = [ 0.5       , -1.18534201,  0.71007123,  1.76015989, -1.97408123, 1.33195381,  2.05750011]
INT_GRIPPER = [0.02]

BAXTER_END_POSE = [0]
R_ARM_END = [0, -0.785, 0, 0, 0, 0, 0]
L_ARM_END = [-1.2       , -0.85051322,  2.00920346,  2.4238917 ,  0.73827866, -1.26725175, -1.15887414]

...
# SEED = 1234
NUM_PROBS = 1
filename = "laundry_probs/put_into_washer.prob"
GOAL = "(BaxterRobotAt baxter robot_end_pose), (BaxterClothAt cloth cloth_target_end_2), (BaxterWasherAt washer washer_init_pose)"

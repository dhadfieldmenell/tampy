...
pp.add('Door', [('geom', 'Door'), ('hinge', 'Vector1d')])
...
class MoveToGrasp(MoveArm):
    def __init__(self, arm):
        ...
        self.args = '(?robot - Robot ?item - Item ?targ - Reachable ?start - RobotPose ?end - RobotPose)'
...
class Grasp(Action):
    def __init__(self):
        ...
        self.pre = [('(Near ?item ?target)', '0:{}'.format(0)),

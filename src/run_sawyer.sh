...
do
	...
	python3.6 -W ignore policy_hooks/run_training.py -c policy_hooks.robosuite.pick_hyp \
                                                       ...
                                                       -pre -post \
                                                       -roll_opt \
                                                       -neg_ratio 0.04 -opt_ratio 0.48 -dagger_ratio 0.48 -roll_ratio 0.000 \
                                                       -descr hierarchical_policy_full_feedback_1objs & 
        sleep 2h 
        pkill -f run_train -9
        pkill -f ros -9
        sleep 5s
	...
	python3.6 -W ignore policy_hooks/run_training.py -c policy_hooks.robosuite.pick_hyp \
                                                       ...
                                                       -descr flat_policy_no_feedback_1objs & 
        sleep 2h
        pkill -f run_train -9
        pkill -f ros -9
        sleep 5s

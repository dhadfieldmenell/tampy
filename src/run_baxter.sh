...
# nose2 test.test_core.test_util_classes.test_baxter_predicates.TestBaxterPredicates.test_retiming --debug
...
# nose2 test.test_core.test_util_classes.test_robots.TestRobots.test_baxter_ik

# nose2 test.test_core.test_util_classes.test_robots.TestRobots.test_can_world --debug

# nose2 test.test_core.test_util_classes.test_robots.TestRobots.test_rrt_planner

# nose2 test.test_core.test_util_classes.test_robots.TestRobots.test_move_holding_env --debug
...
# nose2 test.test_core.test_util_classes.test_openrave_body.TestOpenRAVEBody.test_washer --debug

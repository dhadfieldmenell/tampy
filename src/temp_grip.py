...
items.append({'name': 'door', 'type': 'door_2d', 'handle_dims': (0.3, 0.4), 'door_dims': (0.75, 0.1, 0.4), 'hinge_pos': (-1., 3., 0.4), 'is_fixed': True})
...
for t in range(plan.horizon-1):
    ...
    env.step(ctrl_vec, mode='velocity')
    env.step(ctrl_vec, mode='velocity', view=view)

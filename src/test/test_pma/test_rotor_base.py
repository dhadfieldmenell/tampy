...
class TestBasketDomain(unittest.TestCase):
    ...
    def test_cloth_in_out_washer_plan(self):
        ...
        '5: PUT_INTO_WASHER BAXTER WASHER WASHER_OPEN_POSE_0 CLOTH0 CLOTH_TARGET_END_0 LOAD_WASHER_INTERMEDIATE_POSE CP_EE_0 CLOTH_PUTDOWN_END_0',
        '6: ROTATE BAXTER CLOTH_PUTDOWN_END_0 ROBOT_REGION_3_POSE_0 REGION3',
        '7: MOVETO BAXTER ROBOT_REGION_3_POSE_0 ROBOT_INIT_POSE',
        ]

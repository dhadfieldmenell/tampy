...
class TestBasketDomain(unittest.TestCase):
    ...
    def test_washer_plan(self):
        ...
        # '5: MOVETO BAXTER OPEN_DOOR_END_0 ROBOT_END_POSE'
        ]
    ...
    def test_put_into_basket_plan(self):
        domain_fname = '../domains/laundry_domain/laundry.domain'
        d_c = main.parse_file_to_dict(domain_fname)
        domain = parse_domain_config.ParseDomainConfig.parse(d_c)
        hls = hl_solver.FFSolver(d_c)
        ...
        # # '3: PUT_INTO_BASKET BAXTER CLOTH0 BASKET CLOTH_TARGET_END_0 BASKET_FAR_TARGET CLOTH_PUTDOWN_BEGIN_0 CP_EE_0 CLOTH_PUTDOWN_END_0',
        # '4: CLOTH_PUTDOWN BAXTER CLOTH0 CLOTH_TARGET_END_1 CLOTH_PUTDOWN_BEGIN_0 CP_EE_0 CLOTH_PUTDOWN_END_0',
        # '5: ROTATE BAXTER CLOTH_PUTDOWN_END_0 ROBOT_REGION_2_POSE_0',
        # '6: MOVETO BAXTER ROBOT_REGION_2_POSE_0 ROBOT_INIT_POSE'
        ...
        serializer.write_plan_to_hdf5("cloth_into_basket.hdf5", plan)
        self.assertTrue(result)

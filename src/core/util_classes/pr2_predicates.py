...
class PR2InContactRight(robot_predicates.InContact):
    ...
    def __init__(self, name, params, expected_param_types, env=None, debug=False):
        ...
        super(PR2InContactRight, self).__init__(name, params, expected_param_types, env, debug)
...
class PR2InContactLeft(robot_predicates.InContact):
    ...
    def __init__(self, name, params, expected_param_types, env=None, debug=False):
        ...
        super(PR2InContactLeft, self).__init__(name, params, expected_param_types, env, debug)
...
class PR2InGripperLeft(PR2InGripper):
    ...
    def rot_error(self, obj_trans, robot_trans, axises, arm_joints):
        ...
        obj_jac = np.r_[[0,0,0], obj_jac].reshape((1, 6))
        # Create final 1x26 jacobian matrix
        rot_jac = np.hstack((base_jac, np.zeros((1, 1)), arm_jac, np.zeros((1,9)), obj_jac))
...
class PR2InGripperPosRight(PR2InGripperRight):
    ...
    def __init__(self, name, params, expected_param_types, env = None, debug = False):
        ...
        super(PR2InGripperPosRight, self).__init__(name, params, expected_param_types, env, debug)
...
class PR2InGripperRotRight(PR2InGripperRight):
    ...
    def __init__(self, name, params, expected_param_types, env = None, debug = False):
        ...
        super(PR2InGripperRotRight, self).__init__(name, params, expected_param_types, env, debug)
...
class PR2InGripperPosLeft(PR2InGripperLeft):
    ...
    def __init__(self, name, params, expected_param_types, env = None, debug = False):
        ...
        self.eval_f = lambda x: self.pos_check(x)[0]
        self.eval_grad = lambda x: self.pos_check(x)[1]
        super(PR2InGripperPosLeft, self).__init__(name, params, expected_param_types, env, debug)
...
class PR2InGripperRotLeft(PR2InGripperLeft):
    ...
    def __init__(self, name, params, expected_param_types, env = None, debug = False):
        ...
        self.eval_f = lambda x: self.rot_check(x)[0]
        self.eval_grad = lambda x: self.rot_check(x)[1]
        super(PR2InGripperRotLeft, self).__init__(name, params, expected_param_types, env, debug)
...
class PR2BothEndsInGripper(PR2InGripper):
    ...
    def __init__(self, name, params, expected_param_types, env = None, debug = False):
        self.eval_dim = 6
        super(PR2BothEndsInGripper, self).__init__(name, params, expected_param_types, env, debug)
...
class PR2CloseGrippers(robot_predicates.InContacts):
    def __init__(self, name, params, expected_param_types, env=None, debug=False):
        ...
        super(PR2CloseGrippers, self).__init__(name, params, expected_param_types, env, debug)
...
class PR2EEReachableLeft(PR2EEReachable):
    ...
    def rot_lock(self, obj_trans, robot_trans, axises, arm_joints):
        ...
        for local_dir in np.eye(3):
            ...
            obj_jac = np.r_[[0,0,0], obj_jac].reshape((1, 6))
            # Create final 1x26 jacobian matrix
            rot_jacs.append(np.hstack((base_jac, np.zeros((1, 1)), arm_jac, np.zeros((1,9)), obj_jac)))
...
class PR2EEReachablePosRight(PR2EEReachableRight):
    ...
    def __init__(self, name, params, expected_param_types, env=None, debug=False, steps=const.EEREACHABLE_STEPS):
        ...
        self.attr_dim = 26
        super(PR2EEReachablePosRight, self).__init__(name, params, expected_param_types, env, debug, steps)
...
class PR2EEReachableRotRight(PR2EEReachableRight):
    ...
    def __init__(self, name, params, expected_param_types, env=None, debug=False, steps=0):
        ...
        super(PR2EEReachableRotRight, self).__init__(name, params, expected_param_types, env, debug, steps)
...
class PR2EEReachablePosLeft(PR2EEReachableLeft):
    ...
    def __init__(self, name, params, expected_param_types, env=None, debug=False, steps=const.EEREACHABLE_STEPS):
        ...
        self.eval_grad = self.stacked_grad
        self.attr_dim = 26
        super(PR2EEReachablePosLeft, self).__init__(name, params, expected_param_types, env, debug, steps)
...
class PR2EEReachableRotLeft(PR2EEReachableLeft):
    ...
    def __init__(self, name, params, expected_param_types, env=None, debug=False, steps=0):
        ...
        self.eval_f = lambda x: self.ee_rot_check(x)[0]
        self.eval_grad = lambda x: self.ee_rot_check(x)[1]
        super(PR2EEReachableRotLeft, self).__init__(name, params, expected_param_types, env, debug, steps)

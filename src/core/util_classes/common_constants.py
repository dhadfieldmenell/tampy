...
BIAS_RADIUS = 0.1
ROT_BIAS = np.pi/8
RESAMPLE_FACTOR = [0.025,0.025,0.025]
...
#DRAWER_HANDLE_POS = [0., -0.36, 0.]
#IN_DRAWER_POS = [0., -0.4, 0.03]
IN_DRAWER_POS = [0., -0.38, 0.06]
DRAWER_HANDLE_ORN = [0., 0., 1.57]
#DRAWER_HANDLE_ORN = [0., 0., 0.]
IN_DRAWER_ORN = [0., 0., 0.]

#SHELF_HANDLE_POS = [-0.3, -0.07, 1.0]
SHELF_HANDLE_POS = [-0.3, -0.05, 1.0]
#IN_SHELF_POS = [0.27, 0.15, 0.93]
IN_SHELF_POS = [0.3, 0.13, 0.87]

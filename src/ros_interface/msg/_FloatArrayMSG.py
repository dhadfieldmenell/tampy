...
"""autogenerated by genpy from baxter_plan/FloatArrayMSG.msg. Do not edit."""
import sys
...
class FloatArrayMSG(genpy.Message):
  _md5sum = "788898178a3da2c3718461eecda8f714"
  _type = "baxter_plan/FloatArrayMSG"
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FloatArrayMSG, self).__init__(*args, **kwds)

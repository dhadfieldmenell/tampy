...
PLAN_SWAP_STR = pick_place_str(0, 'ROBOT_INIT_POSE', 'PDP_TARGET7', 0, 0, 6)
PLAN_SWAP_STR.extend(pick_place_str(3, 'PDP_TARGET7', 'PDP_TARGET7', 1, 1, 5))
PLAN_SWAP_STR.extend(pick_place_str(6, 'PDP_TARGET7', 'PDP_TARGET7', 0, 6, 1))
PLAN_SWAP_STR.extend(pick_place_str(6, 'PDP_TARGET7', 'PDP_TARGET7', 1, 5, 0))
...
def main():
    ...
    _test_plan(plan, 'SQP', plot=True, animate=True, verbose=True)

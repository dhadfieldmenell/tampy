...
(cl:ensure-generic-function 'gmms-val :lambda-list '(m))
(cl:defmethod gmms-val ((m <HLProblem>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tamp_ros-msg:gmms-val is deprecated.  Use tamp_ros-msg:gmms instead.")
  (gmms m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <HLProblem>) ostream)
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'gmms))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'gmms))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <HLProblem>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'init_state)))
    ...
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'gmms) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'gmms) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HLProblem>)))
  ...
  "573d764c14495d91c035cf75dd9b1437")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HLProblem)))
  "Returns md5sum for a message object of type 'HLProblem"
  "573d764c14495d91c035cf75dd9b1437")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HLProblem>)))
  ...
  (cl:format cl:nil "int32 solver_id~%int32 server_id~%float32[] init_state~%int32 cond~%string path_to~%string gmms~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HLProblem)))
  "Returns full string definition for message of type 'HLProblem"
  (cl:format cl:nil "int32 solver_id~%int32 server_id~%float32[] init_state~%int32 cond~%string path_to~%string gmms~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <HLProblem>))
  (cl:+ 0
     ...
     4 (cl:length (cl:slot-value msg 'gmms))
))

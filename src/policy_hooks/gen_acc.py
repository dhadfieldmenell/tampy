...
def plot(data, columns, descr, xvars, yvars, separate=True, keyind=0, inter=100, rolling=True, window=100, xlim=None, ylim=None, fname='', witherr=False, style=None):
    ...
    for k in data:
        ...
        if 'goal' in columns:
            ...
            sns_plot.fig.get_axes()[0].legend(bbox_to_anchor=[1., -0.], loc='lower right', handles=handles[1:], labels=labels[1:], facecolor="white", framealpha=0.85, prop={'size': 16, 'family': 'serif'})

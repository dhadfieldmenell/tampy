...
config = {
    ...
    'prim_obs_include': [utils.LEFT_EE_POS_ENUM, utils.RIGHT_EE_POS_ENUM, utils.LEFT_GRIPPER_ENUM, utils.RIGHT_GRIPPER_ENUM, utils.STATE_ENUM], # [utils.OVERHEAD_IMAGE_ENUM],

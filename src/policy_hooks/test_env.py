...
def test_pick_place():
    ...
    '3: CLOTH_PUTDOWN BAXTER CLOTH0 MIDDLE_TARGET_1 CLOTH_PUTDOWN_BEGIN_0 CP_EE_LEFT_0 CLOTH_PUTDOWN_END_0',
    '4: MOVETO BAXTER CLOTH_PUTDOWN_END_0 ROBOT_INIT_POSE',
    '5: MOVETO BAXTER ROBOT_INIT_POSE CLOTH_GRASP_BEGIN_1',
    '6: CLOTH_GRASP_RIGHT BAXTER CLOTH0 MIDDLE_TARGET_1 CLOTH_GRASP_BEGIN_1 CG_EE_RIGHT_1 CLOTH_GRASP_END_1',
    '7: MOVEHOLDING_CLOTH BAXTER CLOTH_GRASP_END_1 CLOTH_PUTDOWN_BEGIN_1 CLOTH0',
    '8: CLOTH_PUTDOWN_RIGHT BAXTER CLOTH0 RIGHT_TARGET_1 CLOTH_PUTDOWN_BEGIN_1 CP_EE_RIGHT_1 CLOTH_PUTDOWN_END_1',
    ]

    plan = hls.get_plan(plan_str, domain, problem)
    baxter, cloth = plan.params['baxter'], plan.params['cloth0']
    cloth.pose[:,0] = [0.6, 0.5, 0.63]
    plan.params['cloth0_init_target'].value[:,0] = cloth.pose[:,0]

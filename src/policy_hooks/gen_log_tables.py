...
keywords = ['image'] # ['retime']
include = [] # ['switch', 'base_namo_random_train'] # ['wed_nocol', 'sun']
label_vars = ['descr', 'permute_hl', 'retime'] # ['eta', 'train_iterations', 'lr', 'prim_weight_decay'] # ['prim_dim', 'prim_n_layers', 'prim_weight_decay', 'eta', 'lr', 'train_iterations']
...
gen_data_plots(xvar='time', yvar=[['success at end', 'success anywhere'], 'subgoals anywhere'], keywords=['image'], lab='test', label_vars=['descr'], separate=True, keyind=5, ylabel='time_4_again_image', exclude=['adjust'], split_runs=False, include=[])
gen_data_plots(xvar='time', yvar=[['success at end', 'success anywhere'], 'subgoals anywhere'], keywords=keywords, lab='test', label_vars=label_vars, separate=True, keyind=5, ylabel='time_4_mostrecent_3', exclude=[], split_runs=False, include=include)
gen_data_plots(xvar='number of plans', yvar=[['success at end', 'success anywhere'], 'subgoals anywhere'], keywords=keywords, lab='test', label_vars=label_vars, separate=True, keyind=5, ylabel='most2recent_2', exclude=[], split_runs=False, include=include, inter=200)

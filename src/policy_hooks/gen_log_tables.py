...
if __name__ == '__main__':
    ...
    while not terminate:
        ...
        gen_data_plots(xvar='time', yvar=['success at end', 'any target', 'subgoals anywhere'], keywords=keywords, lab='test', label_vars=['descr'], separate=True, keyind=5, ylabel='succdataloadtargs', exclude=exclude, split_runs=False, include=include, inter=30, window=50, ylim=[(0.,1.), (0.,1.), (0, 1.), (0, 2.)], fname='endsucc_{}'.format(keywords[0]))
        ...
        gen_data_plots(xvar='time', yvar=['move_to_grasp_right_successes', 'move_to_grasp_right_costs'], keywords=keywords, lab='rollout_info', label_vars=['descr'], separate=True, keyind=5, ylabel='move_policy_successes', exclude=exclude, split_runs=False, include=include, inter=5, window=50, fname='polsuc')
        gen_data_plots(xvar='time', yvar=['move_to_putdown_right_successes', 'move_to_putdown_right_costs'], keywords=keywords, lab='rollout_info', label_vars=['descr'], separate=True, keyind=5, ylabel='moveput_policy_successes', exclude=exclude, split_runs=False, include=include, inter=5, window=50, fname='pol2suc')
        gen_data_plots(xvar='time', yvar=['grasp_right_successes', 'grasp_right_costs'], keywords=keywords, lab='rollout_info', label_vars=['descr'], separate=True, keyind=5, ylabel='grasp_policy_successes', exclude=exclude, split_runs=False, include=include, inter=5, window=50, fname='pol3suc')
        gen_data_plots(xvar='time', yvar=['putdown_right_successes', 'putdown_right_costs'], keywords=keywords, lab='rollout_info', label_vars=['descr'], separate=True, keyind=5, ylabel='put_policy_successes', exclude=exclude, split_runs=False, include=include, inter=5, window=50)

...
def argsparser():
    ...
    parser.add_argument('-neg_ratio', '--perc_negative', type=int, default=0)
    parser.add_argument('-opt_ratio', '--perc_optimal', type=int, default=1)
    parser.add_argument('-dagger_ratio', '--perc_dagger', type=int, default=1)
    parser.add_argument('-roll_ratio', '--perc_rollout', type=int, default=1)

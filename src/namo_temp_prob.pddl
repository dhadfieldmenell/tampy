...
(:init  (CanInReach can4) (CanInReach can2) (CanInReach can3) (CanInReach can0) (CanAtTarget can0 can1_end_target) (CanInReach can1) (CanAtTarget can1 can0_end_target))

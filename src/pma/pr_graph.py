...
"""
def p_mod_abs(domain_config, problem_config, max_iter=100):
    ...
    if problem.goal_test():
        ...
        return False
    n0 = HLSearchNode(domain, domain.hl_solver.translate_problem(problem), problem)
    ...
    for _ in range(max_iter):
        ...
        if n.is_hl_node():
            ...
            if n.gen_child():
                ...
                c = HLSearchNode(domain, domain.hl_solver.translate_problem(n_problem), n_problem, prefix=n.curr_plan.prefix(fail_step))
                Q.put((-c.heuristic(), c))
